...
public:
    ...
    struct UploadConfig {
        ...
        CompressionAlgorithm compressionAlgo = CompressionAlgorithm::ZSTD; // 压缩算法
        bool enableChecksum = true;         // 是否启用完整性校验
        ChecksumAlgorithm checksumAlgo = ChecksumAlgorithm::SHA256;  // 校验算法
    ...
    struct NetworkConfig {
        ...
        uint16_t proxyPort = 8080;             // 代理服务器端口
